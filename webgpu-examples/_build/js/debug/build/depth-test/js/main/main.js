...
function _M0TPC13ref3RefGORP411emadurandal17WebGPU_2dexamples12depth_2dtest6common14WebGPURendererE(param0) {
  this.val = param0;
}
...
function _M0TP311emadurandal6WebGPU15webgpu__objects38WebGPURenderPassDepthStencilAttachment(param0, param1, param2, param3, param4, param5, param6, param7, param8) {
  this.view = param0;
  this.depthClearValue = param1;
  this.depthLoadOp = param2;
  this.depthStoreOp = param3;
  this.depthReadOnly = param4;
  this.stencilClearValue = param5;
  this.stencilLoadOp = param6;
  this.stencilStoreOp = param7;
  this.stencilReadOnly = param8;
}
...
const _M0FP311emadurandal6WebGPU15webgpu__objects21device__createTexture = (device, width, height, format, usage) =>
   device.createTexture({
     size: { width, height },
     format,
     usage: usage >>> 0,
   });
const _M0FP311emadurandal6WebGPU15webgpu__objects20device__createBuffer = (device, size, usage) =>
...
const _M0FP311emadurandal6WebGPU15webgpu__objects27renderPass__setVertexBuffer = (pass, slot, buffer, offset, size) =>
   pass.setVertexBuffer(slot, buffer, offset, size);
const _M0FP311emadurandal6WebGPU15webgpu__objects26renderPass__setIndexBuffer = (pass, buffer, formatStr, offset, size) =>
   pass.setIndexBuffer(buffer, formatStr, offset, size);
const _M0FP311emadurandal6WebGPU15webgpu__objects23renderPass__drawIndexed = (pass, indexCount, instanceCount, firstIndex, baseVertex, firstInstance) =>
   pass.drawIndexed(
     indexCount,
     instanceCount,
     firstIndex,
...
const _M0FP311emadurandal6WebGPU15webgpu__objects18queue__writeBuffer = (queue, buffer, offset, data) =>
...
function _M0TP311emadurandal6WebGPU6webgpu9GPUBuffer(param0) {
  this.raw = param0;
}
...
function _M0TP311emadurandal6WebGPU13webgpu__enums21GPUVertexBufferLayout(param0, param1, param2) {
  this.array_stride = param0;
  this.step_mode = param1;
  this.attributes = param2;
}
function _M0TP311emadurandal6WebGPU13webgpu__enums18GPUVertexAttribute(param0, param1, param2) {
  this.format = param0;
  this.offset = param1;
  this.shader_location = param2;
}
...
function _M0TP411emadurandal17WebGPU_2dexamples12depth_2dtest6common14WebGPURenderer(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9) {
  this.context = param0;
  this.device = param1;
  this.queue = param2;
  this.pipeline = param3;
  this.depth_texture = param4;
  this.depth_view = param5;
  this.vertex_buffer_a = param6;
  this.vertex_buffer_b = param7;
  this.index_buffer = param8;
  this.frame = param9;
}
...
function _M0DTP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main95_24emadurandal_2fWebGPU_2dexamples_2fdepth_2dtest_2fjs_2fmain_2ecreate__webgpu__renderer__asyncL5State8State__0(param0) {
  this._0 = param0;
}
_M0DTP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main95_24emadurandal_2fWebGPU_2dexamples_2fdepth_2dtest_2fjs_2fmain_2ecreate__webgpu__renderer__asyncL5State8State__0.prototype.$tag = 0;
...
const _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common13canvas__width = 800;
const _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common14canvas__height = 600;
const _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common16half__separation = 1.25;
const _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common21vertex__stride__bytes = 32;
const _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common16verts__per__cube = 8;
const _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common24vertex__bytes__per__cube = 256n;
const _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common17index__u16__count = 36;
const _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common22camera__elevation__rad = 0.38;
const _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common19depth__shader__code = "struct VertexOut {\n  @builtin(position) position: vec4<f32>,\n  @location(0) color: vec3<f32>,\n};\n\n@vertex\nfn vertexMain(\n  @location(0) clip_pos: vec4<f32>,\n  @location(1) color: vec3<f32>,\n) -> VertexOut {\n  var o: VertexOut;\n  o.position = clip_pos;\n  o.color = color;\n  return o;\n}\n\n@fragment\nfn fragmentMain(@location(0) color: vec3<f32>) -> @location(0) vec4<f32> {\n  return vec4<f32>(color, 1.0);\n}\n";
...
const _M0FP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main14demo__renderer = _M0FPC13ref3newGORP411emadurandal17WebGPU_2dexamples12depth_2dtest6common14WebGPURendererE(undefined);
const _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common27index__buffer__byte__length = _M0MPC13int3Int10to__uint64(Math.imul(_M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common17index__u16__count, 2) | 0);
...
function _M0MPC15array5Array2atGUdddEE(self, index) {
  const len = self.length;
  if (index >= 0 && index < len) {
    $bound_check(self, index);
    return self[index];
...
function _M0FPC13ref3newGORP411emadurandal17WebGPU_2dexamples12depth_2dtest6common14WebGPURendererE(x) {
  return new _M0TPC13ref3RefGORP411emadurandal17WebGPU_2dexamples12depth_2dtest6common14WebGPURendererE(x);
}
...
function _M0MP311emadurandal6WebGPU13webgpu__enums14GPUIndexFormat11to__js__tag(self) {
  if (self === 0) {
    return "uint16";
  } else {
    return "uint32";
...
function _M0MP311emadurandal6WebGPU15webgpu__objects38WebGPURenderPassDepthStencilAttachment11new_2einner(view, depthClearValue, depthLoadOp, depthStoreOp, depthReadOnly, stencilClearValue, stencilLoadOp, stencilStoreOp, stencilReadOnly) {
  return new _M0TP311emadurandal6WebGPU15webgpu__objects38WebGPURenderPassDepthStencilAttachment(view, depthClearValue, depthLoadOp, depthStoreOp, depthReadOnly, stencilClearValue, stencilLoadOp, stencilStoreOp, stencilReadOnly);
}
function _M0FP311emadurandal6WebGPU15webgpu__objects48create__render__pass__depth__stencil__attachment(view) {
  return _M0MP311emadurandal6WebGPU15webgpu__objects38WebGPURenderPassDepthStencilAttachment11new_2einner(view, new _M0DTPC16option6OptionGdE4Some(1), "clear", "store", false, 0, undefined, undefined, -1);
}
...
function _M0FP311emadurandal6WebGPU15webgpu__objects19js__u64__to__double(n) {
  return $f64_convert_i32_u(Number(BigInt.asUintN(32, n)) | 0);
}
...
function _M0FP311emadurandal6WebGPU15webgpu__objects50webgpu__render__pass__encoder__set__vertex__buffer(renderPass, slot, buffer, offset, size) {
  _M0FP311emadurandal6WebGPU15webgpu__objects27renderPass__setVertexBuffer(renderPass.encoder, slot, buffer, _M0FP311emadurandal6WebGPU15webgpu__objects19js__u64__to__double(offset), _M0FP311emadurandal6WebGPU15webgpu__objects19js__u64__to__double(size));
}
function _M0FP311emadurandal6WebGPU15webgpu__objects49webgpu__render__pass__encoder__set__index__buffer(renderPass, buffer, format, offset, size) {
  _M0FP311emadurandal6WebGPU15webgpu__objects26renderPass__setIndexBuffer(renderPass.encoder, buffer, _M0MP311emadurandal6WebGPU13webgpu__enums14GPUIndexFormat11to__js__tag(format), _M0FP311emadurandal6WebGPU15webgpu__objects19js__u64__to__double(offset), _M0FP311emadurandal6WebGPU15webgpu__objects19js__u64__to__double(size));
}
function _M0FP311emadurandal6WebGPU15webgpu__objects44webgpu__render__pass__encoder__draw__indexed(renderPass, indexCount, instanceCount, firstIndex, baseVertex, firstInstance) {
  _M0FP311emadurandal6WebGPU15webgpu__objects23renderPass__drawIndexed(renderPass.encoder, indexCount, instanceCount, firstIndex, baseVertex, firstInstance);
}
...
function _M0FP311emadurandal6WebGPU15webgpu__objects28webgpu__queue__write__buffer(queue, buffer, offset, data) {
  _M0FP311emadurandal6WebGPU15webgpu__objects18queue__writeBuffer(queue.queue, buffer, _M0FP311emadurandal6WebGPU15webgpu__objects19js__u64__to__double(offset), data);
}
...
function _M0FP311emadurandal6WebGPU15webgpu__objects31webgpu__device__create__texture(device, width, height, format, usage) {
  return _M0MP311emadurandal6WebGPU15webgpu__objects13WebGPUTexture3new(_M0FP311emadurandal6WebGPU15webgpu__objects21device__createTexture(device.device, width, height, format, _M0FP311emadurandal6WebGPU15webgpu__objects19js__u64__to__double(usage)));
}
function _M0FP311emadurandal6WebGPU15webgpu__objects30webgpu__device__create__buffer(device, size, usage) {
  return _M0FP311emadurandal6WebGPU15webgpu__objects20device__createBuffer(device.device, _M0FP311emadurandal6WebGPU15webgpu__objects19js__u64__to__double(size), _M0FP311emadurandal6WebGPU15webgpu__objects19js__u64__to__double(usage));
}
...
function _M0MP311emadurandal6WebGPU6webgpu9GPUDevice14create__buffer(self, size, usage) {
  return new _M0TP311emadurandal6WebGPU6webgpu9GPUBuffer(_M0FP311emadurandal6WebGPU15webgpu__objects30webgpu__device__create__buffer(self.raw, size, usage));
}
function _M0MP311emadurandal6WebGPU6webgpu9GPUDevice15create__texture(self, width, height, format, usage) {
  return new _M0TP311emadurandal6WebGPU6webgpu10GPUTexture(_M0FP311emadurandal6WebGPU15webgpu__objects31webgpu__device__create__texture(self.raw, width, height, format, usage));
}
function _M0MP311emadurandal6WebGPU6webgpu8GPUQueue13write__buffer(self, buffer, offset, data) {
  _M0FP311emadurandal6WebGPU15webgpu__objects28webgpu__queue__write__buffer(self.raw, buffer.raw, offset, data);
}
function _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder19set__vertex__buffer(self, slot, buffer, offset, size) {
  _M0FP311emadurandal6WebGPU15webgpu__objects50webgpu__render__pass__encoder__set__vertex__buffer(self.raw, slot, buffer.raw, offset, size);
}
function _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder18set__index__buffer(self, buffer, format, offset, size) {
  _M0FP311emadurandal6WebGPU15webgpu__objects49webgpu__render__pass__encoder__set__index__buffer(self.raw, buffer.raw, format, offset, size);
}
...
function _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder21draw__indexed_2einner(self, index_count, instance_count, first_index, base_vertex, first_instance) {
  _M0FP311emadurandal6WebGPU15webgpu__objects44webgpu__render__pass__encoder__draw__indexed(self.raw, index_count, instance_count, first_index, base_vertex, first_instance);
}
...
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__u32__le(buf, off, u) {
  _M0MPC15array5Array3setGyE(buf, off, _M0MPC14uint4UInt8to__byte(u & 255));
  _M0MPC15array5Array3setGyE(buf, off + 1 | 0, _M0MPC14uint4UInt8to__byte((u >>> 8 | 0) & 255));
  _M0MPC15array5Array3setGyE(buf, off + 2 | 0, _M0MPC14uint4UInt8to__byte((u >>> 16 | 0) & 255));
  _M0MPC15array5Array3setGyE(buf, off + 3 | 0, _M0MPC14uint4UInt8to__byte((u >>> 24 | 0) & 255));
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__u16__le(buf, off, u) {
  _M0MPC15array5Array3setGyE(buf, off, _M0MPC14uint4UInt8to__byte(u & 255));
  _M0MPC15array5Array3setGyE(buf, off + 1 | 0, _M0MPC14uint4UInt8to__byte((u >>> 8 | 0) & 255));
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__f32__le(buf, off, d) {
  const u = $i32_reinterpret_f32(Math.fround(d));
  _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__u32__le(buf, off, u);
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common11sin__approx(a) {
  const two_pi = 6.28318530717958623;
  const x = new _M0TPB8MutLocalGdE(a);
  while (true) {
    if (x.val > two_pi) {
      x.val = x.val - two_pi;
      continue;
  ...
  const x2 = x.val * x.val;
  const x3 = x2 * x.val;
  const x5 = x3 * x2;
  const x7 = x5 * x2;
  return x.val - x3 / 6 + x5 / 120 - x7 / 5040;
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common11cos__approx(a) {
  return _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common11sin__approx(a + 1.57079632679489656);
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common9mat4__mul(a, b) {
  const o = _M0MPC15array5Array4makeGdE(16, 0);
  let _tmp = 0;
  while (true) {
    const j = _tmp;
    if (j < 4) {
      ...
      while (true) {
        const i = _tmp$2;
        if (i < 4) {
          const s = new _M0TPB8MutLocalGdE(0);
          let _tmp$3 = 0;
          while (true) {
            const k = _tmp$3;
            if (k < 4) {
              s.val = s.val + _M0MPC15array5Array2atGdE(a, (Math.imul(k, 4) | 0) + i | 0) * _M0MPC15array5Array2atGdE(b, (Math.imul(j, 4) | 0) + k | 0);
              _tmp$3 = k + 1 | 0;
              continue;
            } else {
              break;
          ...
          _M0MPC15array5Array3setGdE(o, (Math.imul(j, 4) | 0) + i | 0, s.val);
          _tmp$2 = i + 1 | 0;
          continue;
        } else {
          break;
...
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common15mat4__translate(tx, ty, tz) {
  const m = _M0MPC15array5Array4makeGdE(16, 0);
  _M0MPC15array5Array3setGdE(m, 0, 1);
  _M0MPC15array5Array3setGdE(m, 5, 1);
  _M0MPC15array5Array3setGdE(m, 10, 1);
  _M0MPC15array5Array3setGdE(m, 12, tx);
  _M0MPC15array5Array3setGdE(m, 13, ty);
  _M0MPC15array5Array3setGdE(m, 14, tz);
  _M0MPC15array5Array3setGdE(m, 15, 1);
  return m;
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common15mat4__rotate__x(c, s) {
  const m = _M0MPC15array5Array4makeGdE(16, 0);
  _M0MPC15array5Array3setGdE(m, 0, 1);
  _M0MPC15array5Array3setGdE(m, 1, 0);
  _M0MPC15array5Array3setGdE(m, 2, 0);
  _M0MPC15array5Array3setGdE(m, 3, 0);
  _M0MPC15array5Array3setGdE(m, 4, 0);
  _M0MPC15array5Array3setGdE(m, 5, c);
  _M0MPC15array5Array3setGdE(m, 6, s);
  _M0MPC15array5Array3setGdE(m, 7, 0);
  _M0MPC15array5Array3setGdE(m, 8, 0);
  _M0MPC15array5Array3setGdE(m, 9, -s);
  _M0MPC15array5Array3setGdE(m, 10, c);
  _M0MPC15array5Array3setGdE(m, 11, 0);
  _M0MPC15array5Array3setGdE(m, 12, 0);
  _M0MPC15array5Array3setGdE(m, 13, 0);
  _M0MPC15array5Array3setGdE(m, 14, 0);
  _M0MPC15array5Array3setGdE(m, 15, 1);
  return m;
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common15mat4__rotate__y(c, s) {
  const m = _M0MPC15array5Array4makeGdE(16, 0);
  _M0MPC15array5Array3setGdE(m, 0, c);
  _M0MPC15array5Array3setGdE(m, 1, 0);
  _M0MPC15array5Array3setGdE(m, 2, -s);
  _M0MPC15array5Array3setGdE(m, 3, 0);
  _M0MPC15array5Array3setGdE(m, 4, 0);
  _M0MPC15array5Array3setGdE(m, 5, 1);
  _M0MPC15array5Array3setGdE(m, 6, 0);
  _M0MPC15array5Array3setGdE(m, 7, 0);
  _M0MPC15array5Array3setGdE(m, 8, s);
  _M0MPC15array5Array3setGdE(m, 9, 0);
  _M0MPC15array5Array3setGdE(m, 10, c);
  _M0MPC15array5Array3setGdE(m, 11, 0);
  _M0MPC15array5Array3setGdE(m, 12, 0);
  _M0MPC15array5Array3setGdE(m, 13, 0);
...
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common11mat4__ortho(l, r, b, t, n, f) {
  const m = _M0MPC15array5Array4makeGdE(16, 0);
  _M0MPC15array5Array3setGdE(m, 0, 2 / (r - l));
  _M0MPC15array5Array3setGdE(m, 5, 2 / (t - b));
  _M0MPC15array5Array3setGdE(m, 10, -2 / (f - n));
  _M0MPC15array5Array3setGdE(m, 12, -(r + l) / (r - l));
  _M0MPC15array5Array3setGdE(m, 13, -(t + b) / (t - b));
  _M0MPC15array5Array3setGdE(m, 14, -(f + n) / (f - n));
  _M0MPC15array5Array3setGdE(m, 15, 1);
  return m;
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common33mat4__clip__gl__depth__to__webgpu() {
  const m = _M0MPC15array5Array4makeGdE(16, 0);
  _M0MPC15array5Array3setGdE(m, 0, 1);
  _M0MPC15array5Array3setGdE(m, 5, 1);
  _M0MPC15array5Array3setGdE(m, 10, 0.5);
  _M0MPC15array5Array3setGdE(m, 14, 0.5);
  _M0MPC15array5Array3setGdE(m, 15, 1);
  return m;
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common14transform__hom(m, x, y, z) {
  const w = 1;
  const ox = _M0MPC15array5Array2atGdE(m, 0) * x + _M0MPC15array5Array2atGdE(m, 4) * y + _M0MPC15array5Array2atGdE(m, 8) * z + _M0MPC15array5Array2atGdE(m, 12) * w;
  const oy = _M0MPC15array5Array2atGdE(m, 1) * x + _M0MPC15array5Array2atGdE(m, 5) * y + _M0MPC15array5Array2atGdE(m, 9) * z + _M0MPC15array5Array2atGdE(m, 13) * w;
  const oz = _M0MPC15array5Array2atGdE(m, 2) * x + _M0MPC15array5Array2atGdE(m, 6) * y + _M0MPC15array5Array2atGdE(m, 10) * z + _M0MPC15array5Array2atGdE(m, 14) * w;
  const ow = _M0MPC15array5Array2atGdE(m, 3) * x + _M0MPC15array5Array2atGdE(m, 7) * y + _M0MPC15array5Array2atGdE(m, 11) * z + _M0MPC15array5Array2atGdE(m, 15) * w;
  return { _0: ox, _1: oy, _2: oz, _3: ow };
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common20cube__local__corners() {
  return [{ _0: -1, _1: -1, _2: -1 }, { _0: 1, _1: -1, _2: -1 }, { _0: 1, _1: 1, _2: -1 }, { _0: -1, _1: 1, _2: -1 }, { _0: -1, _1: -1, _2: 1 }, { _0: 1, _1: -1, _2: 1 }, { _0: 1, _1: 1, _2: 1 }, { _0: -1, _1: 1, _2: 1 }];
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common23index__cube__u16__bytes() {
  const buf = _M0MPC15array5Array4makeGyE(72, 0);
  const idx = [0, 1, 2, 2, 3, 0, 4, 5, 6, 6, 7, 4, 0, 4, 7, 7, 3, 0, 1, 5, 6, 6, 2, 1, 0, 1, 5, 5, 4, 0, 3, 2, 6, 6, 7, 3];
  let _tmp = 0;
  while (true) {
    const i = _tmp;
    if (i < _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common17index__u16__count) {
      _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__u16__le(buf, Math.imul(i, 2) | 0, _M0MPC15array5Array2atGjE(idx, i));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common24write__cube__interleaved(buf, mvp, color_r, color_g, color_b) {
  const corners = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common20cube__local__corners();
  let _tmp = 0;
  while (true) {
    const vi = _tmp;
    if (vi < _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common16verts__per__cube) {
      let ly;
      let lx;
      let lz;
      _L: {
        const _bind = _M0MPC15array5Array2atGUdddEE(corners, vi);
        const _lx = _bind._0;
        const _ly = _bind._1;
        const _lz = _bind._2;
        ly = _ly;
      ...
      let cw;
      _L$2: {
        const _bind = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common14transform__hom(mvp, lx, ly, lz);
        const _cx = _bind._0;
        const _cy = _bind._1;
        const _cz = _bind._2;
        const _cw = _bind._3;
      ...
      const base = Math.imul(vi, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common21vertex__stride__bytes) | 0;
      _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__f32__le(buf, base, cx);
      _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__f32__le(buf, base + 4 | 0, cy);
      _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__f32__le(buf, base + 8 | 0, cz);
      _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__f32__le(buf, base + 12 | 0, cw);
      _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__f32__le(buf, base + 16 | 0, color_r);
      _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__f32__le(buf, base + 20 | 0, color_g);
      _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common12put__f32__le(buf, base + 24 | 0, color_b);
      _tmp = vi + 1 | 0;
      continue;
    } else {
      return;
...
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common16create__renderer(context) {
  let format;
  let device;
  let canvas_context;
  let queue;
  ...
  const shader = _M0MP311emadurandal6WebGPU6webgpu9GPUDevice22create__shader__module(device, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common19depth__shader__code);
  const vertex_layout = new _M0TP311emadurandal6WebGPU13webgpu__enums21GPUVertexBufferLayout(32n, 0, [new _M0TP311emadurandal6WebGPU13webgpu__enums18GPUVertexAttribute(2, 0n, 0), new _M0TP311emadurandal6WebGPU13webgpu__enums18GPUVertexAttribute(1, 16n, 1)]);
  const pipeline_descriptor = new _M0TP311emadurandal6WebGPU6webgpu27GPURenderPipelineDescriptor(shader, shader, 3, [format], [vertex_layout], "depth24plus");
  ...
  const vusage = 40n;
  const vertex_buffer_a = _M0MP311emadurandal6WebGPU6webgpu9GPUDevice14create__buffer(device, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common24vertex__bytes__per__cube, vusage);
  const vertex_buffer_b = _M0MP311emadurandal6WebGPU6webgpu9GPUDevice14create__buffer(device, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common24vertex__bytes__per__cube, vusage);
  const iusage = 24n;
  const index_buffer = _M0MP311emadurandal6WebGPU6webgpu9GPUDevice14create__buffer(device, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common27index__buffer__byte__length, iusage);
  const index_bytes = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common23index__cube__u16__bytes();
  _M0MP311emadurandal6WebGPU6webgpu8GPUQueue13write__buffer(queue, index_buffer, 0n, index_bytes);
  const depth_texture = _M0MP311emadurandal6WebGPU6webgpu9GPUDevice15create__texture(device, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common13canvas__width, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common14canvas__height, "depth24plus", 16n);
  const depth_view = _M0MP311emadurandal6WebGPU6webgpu10GPUTexture12create__view(depth_texture);
  return new _M0TP411emadurandal17WebGPU_2dexamples12depth_2dtest6common14WebGPURenderer(canvas_context, device, queue, pipeline, depth_texture, depth_view, vertex_buffer_a, vertex_buffer_b, index_buffer, _M0FPC13ref3newGiE(0));
}
function _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common13render__frame(renderer) {
  renderer.frame.val = renderer.frame.val + 1 | 0;
  const t = (renderer.frame.val + 0) * 0.03;
  const c = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common11cos__approx(t);
  const s = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common11sin__approx(t);
  const r = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common15mat4__rotate__y(c, s);
  const ta = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common15mat4__translate(-_M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common16half__separation, 0, 0);
  const tb = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common15mat4__translate(_M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common16half__separation, 0, 0);
  const ma = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common9mat4__mul(r, ta);
  const mb = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common9mat4__mul(r, tb);
  const v_cos = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common11cos__approx(_M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common22camera__elevation__rad);
  const v_sin = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common11sin__approx(_M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common22camera__elevation__rad);
  const view = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common9mat4__mul(_M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common15mat4__rotate__x(v_cos, v_sin), _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common15mat4__translate(0, 0, -8));
  const proj = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common11mat4__ortho(-5, 5, -5, 5, 0.1, 50);
  const pv = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common9mat4__mul(proj, view);
  const z_ndc_webgpu = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common33mat4__clip__gl__depth__to__webgpu();
  const mvp_a = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common9mat4__mul(z_ndc_webgpu, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common9mat4__mul(pv, ma));
  const mvp_b = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common9mat4__mul(z_ndc_webgpu, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common9mat4__mul(pv, mb));
  const bytes_a = _M0MPC15array5Array4makeGyE(Math.imul(_M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common16verts__per__cube, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common21vertex__stride__bytes) | 0, 0);
  const bytes_b = _M0MPC15array5Array4makeGyE(Math.imul(_M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common16verts__per__cube, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common21vertex__stride__bytes) | 0, 0);
  _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common24write__cube__interleaved(bytes_a, mvp_a, 0.85, 0.35, 0.25);
  _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common24write__cube__interleaved(bytes_b, mvp_b, 0.25, 0.55, 0.95);
  _M0MP311emadurandal6WebGPU6webgpu8GPUQueue13write__buffer(renderer.queue, renderer.vertex_buffer_a, 0n, bytes_a);
  _M0MP311emadurandal6WebGPU6webgpu8GPUQueue13write__buffer(renderer.queue, renderer.vertex_buffer_b, 0n, bytes_b);
  const texture = _M0MP311emadurandal6WebGPU6webgpu16GPUCanvasContext21get__current__texture(renderer.context);
  const color_view = _M0MP311emadurandal6WebGPU6webgpu10GPUTexture12create__view(texture);
  const encoder = _M0MP311emadurandal6WebGPU6webgpu9GPUDevice24create__command__encoder(renderer.device);
  const depth_att = _M0FP311emadurandal6WebGPU15webgpu__objects48create__render__pass__depth__stencil__attachment(renderer.depth_view);
  const render_pass = _M0MP311emadurandal6WebGPU6webgpu17GPUCommandEncoder19begin__render__pass(encoder, new _M0TP311emadurandal6WebGPU6webgpu23GPURenderPassDescriptor([new _M0TP311emadurandal6WebGPU6webgpu28GPURenderPassColorAttachment(color_view, new _M0TP311emadurandal6WebGPU13webgpu__enums8GPUColor(0.08, 0.08, 0.12, 1), 1, 0)], depth_att));
  _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder13set__pipeline(render_pass, renderer.pipeline);
  _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder18set__index__buffer(render_pass, renderer.index_buffer, 0, 0n, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common27index__buffer__byte__length);
  _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder19set__vertex__buffer(render_pass, 0, renderer.vertex_buffer_a, 0n, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common24vertex__bytes__per__cube);
  _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder21draw__indexed_2einner(render_pass, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common17index__u16__count, 1, 0, 0, 0);
  _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder19set__vertex__buffer(render_pass, 0, renderer.vertex_buffer_b, 0n, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common24vertex__bytes__per__cube);
  _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder21draw__indexed_2einner(render_pass, _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common17index__u16__count, 1, 0, 0, 0);
  ...
  _M0FP311emadurandal6WebGPU6webgpu20textureView__release(color_view);
  _M0MP311emadurandal6WebGPU6webgpu16GPUCanvasContext7present(renderer.context);
}
function _M0FP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main31create__webgpu__renderer__async(canvas, _cont, _err_cont) {
  const _async_driver = (_state) => {
    const _State_0 = _state;
    const _cont_param = _State_0._0;
    ...
    let renderer;
    _L: {
      const _bind = _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common16create__renderer(ctx);
      if (_bind === undefined) {
        return new _M0DTPC16result6ResultGOuRPC15error5ErrorE2Ok(_M0FPB7printlnGsE("depth-test: failed to create renderer"));
      } else {
        const _Some = _bind;
    ...
    _M0FP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main14demo__renderer.val = renderer;
    return new _M0DTPC16result6ResultGOuRPC15error5ErrorE2Ok(_M0FPB7printlnGsE("depth-test: renderer ready (use depth_test_render_tick in rAF)"));
  };
  const _bind = _M0FP411emadurandal17WebGPU_2dexamples6common7browser32gpu__context__from__html__canvas(canvas, (_cont_param) => {
    let _err;
    _L: {
      const _bind$2 = _async_driver(new _M0DTP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main95_24emadurandal_2fWebGPU_2dexamples_2fdepth_2dtest_2fjs_2fmain_2ecreate__webgpu__renderer__asyncL5State8State__0(_cont_param));
      let _bind$3;
      if (_bind$2.$tag === 1) {
        const _ok = _bind$2;
        _bind$3 = _ok._0;
  ...
  if (_bind$2 === undefined) {
    ...
    const _Some = _bind$2;
    const _payload = _Some;
    return _async_driver(new _M0DTP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main95_24emadurandal_2fWebGPU_2dexamples_2fdepth_2dtest_2fjs_2fmain_2ecreate__webgpu__renderer__asyncL5State8State__0(_payload));
  }
}
function _M0FP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main24create__webgpu__renderer(canvas) {
  return _M0MP311moonbitlang5async9js__async7Promise11from__asyncGuE((_cont, _err_cont) => _M0FP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main31create__webgpu__renderer__async(canvas, _cont, _err_cont), _M0DTPC16option6OptionGRP311moonbitlang5async9js__async11AbortSignalE4None__);
}
function _M0FP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main25depth__test__render__tick() {
  let renderer;
  _L: {
    const _bind = _M0FP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main14demo__renderer.val;
    if (_bind === undefined) {
      return;
    } else {
      const _Some = _bind;
  ...
  _M0FP411emadurandal17WebGPU_2dexamples12depth_2dtest6common13render__frame(renderer);
}
(() => {
  _M0FPB7printlnGsE("depth-test js stub");
})();
export { _M0FP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main24create__webgpu__renderer as create_webgpu_renderer, _M0FP511emadurandal17WebGPU_2dexamples12depth_2dtest2js4main25depth__test__render__tick as depth_test_render_tick }
