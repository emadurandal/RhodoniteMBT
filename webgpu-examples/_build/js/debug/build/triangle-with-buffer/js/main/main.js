...
function _M0TP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common14WebGPURenderer(param0, param1, param2, param3, param4, param5) {
  this.context = param0;
  this.device = param1;
  this.queue = param2;
  this.pipeline = param3;
  this.vertex_buffer = param4;
  this.index_buffer = param5;
}
...
function _M0DTP511emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer2js4main107_24emadurandal_2fWebGPU_2dexamples_2ftriangle_2dwith_2dbuffer_2fjs_2fmain_2ecreate__webgpu__renderer__asyncL5State8State__0(param0) {
  this._0 = param0;
}
_M0DTP511emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer2js4main107_24emadurandal_2fWebGPU_2dexamples_2ftriangle_2dwith_2dbuffer_2fjs_2fmain_2ecreate__webgpu__renderer__asyncL5State8State__0.prototype.$tag = 0;
...
const _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common28vertex__buffer__byte__length = 96n;
const _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common39index__buffer__allocation__byte__length = 8n;
const _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common41index__buffer__index__range__byte__length = 6n;
const _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common22triangle__shader__code = "struct VertexOutput {\n  @builtin(position) position: vec4<f32>,\n  @location(0) color: vec3<f32>,\n};\n\n@vertex\nfn vertexMain(\n  @location(0) pos: vec2<f32>,\n  @location(1) color: vec3<f32>,\n) -> VertexOutput {\n  var out: VertexOutput;\n  out.position = vec4<f32>(pos, 0.0, 1.0);\n  out.color = color;\n  return out;\n}\n\n@fragment\nfn fragmentMain(@location(0) color: vec3<f32>) -> @location(0) vec4<f32> {\n  return vec4<f32>(color, 1.0);\n}\n";
...
function _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common12put__u16__le(buf, off, u) {
...
function _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common12put__u32__le(buf, off, u) {
  _M0MPC15array5Array3setGyE(buf, off, _M0MPC14uint4UInt8to__byte(u & 255));
  _M0MPC15array5Array3setGyE(buf, off + 1 | 0, _M0MPC14uint4UInt8to__byte((u >>> 8 | 0) & 255));
...
function _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common36vertex__triangle__interleaved__bytes() {
  const stride = 32;
  const n = 3;
  const total = Math.imul(stride, n) | 0;
  const buf = _M0MPC15array5Array4makeGyE(total, 0);
  const put_vertex = (base, px, py, cr, cg, cb) => {
    _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common12put__u32__le(buf, base, px);
    _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common12put__u32__le(buf, base + 4 | 0, py);
    _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common12put__u32__le(buf, base + 8 | 0, cr);
    _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common12put__u32__le(buf, base + 12 | 0, cg);
    _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common12put__u32__le(buf, base + 16 | 0, cb);
  };
  put_vertex(0, 0, 1056964608, 1065353216, 0, 0);
  put_vertex(stride, -1090519040, -1090519040, 0, 1065353216, 0);
  put_vertex(Math.imul(stride, 2) | 0, 1056964608, -1090519040, 0, 0, 1065353216);
  return buf;
}
function _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common27index__triangle__u16__bytes() {
  const buf = _M0MPC15array5Array4makeGyE(8, 0);
  _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common12put__u16__le(buf, 0, 0);
  _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common12put__u16__le(buf, 2, 1);
  _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common12put__u16__le(buf, 4, 2);
  return buf;
}
function _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common16create__pipeline(device, format) {
  const shader = _M0MP311emadurandal6WebGPU6webgpu9GPUDevice22create__shader__module(device, _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common22triangle__shader__code);
  const vertex_layout = new _M0TP311emadurandal6WebGPU13webgpu__enums21GPUVertexBufferLayout(32n, 0, [new _M0TP311emadurandal6WebGPU13webgpu__enums18GPUVertexAttribute(0, 0n, 0), new _M0TP311emadurandal6WebGPU13webgpu__enums18GPUVertexAttribute(1, 8n, 1)]);
  const pipeline_descriptor = new _M0TP311emadurandal6WebGPU6webgpu27GPURenderPipelineDescriptor(shader, shader, 3, [format], [vertex_layout], undefined);
...
function _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common16create__renderer(context) {
  let format;
  let device;
  let canvas_context;
  let queue;
  ...
  const vertex_bytes = _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common36vertex__triangle__interleaved__bytes();
  const vusage = 40n;
  const vbuf = _M0MP311emadurandal6WebGPU6webgpu9GPUDevice14create__buffer(device, _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common28vertex__buffer__byte__length, vusage);
  _M0MP311emadurandal6WebGPU6webgpu8GPUQueue13write__buffer(queue, vbuf, 0n, vertex_bytes);
  const index_bytes = _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common27index__triangle__u16__bytes();
  const iusage = 24n;
  const ibuf = _M0MP311emadurandal6WebGPU6webgpu9GPUDevice14create__buffer(device, _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common39index__buffer__allocation__byte__length, iusage);
  _M0MP311emadurandal6WebGPU6webgpu8GPUQueue13write__buffer(queue, ibuf, 0n, index_bytes);
  const pipeline = _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common16create__pipeline(device, format);
  return new _M0TP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common14WebGPURenderer(canvas_context, device, queue, pipeline, vbuf, ibuf);
}
function _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common28render__frame__with__options(renderer, clearColor, index_count) {
  ...
  _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder19set__vertex__buffer(render_pass, 0, renderer.vertex_buffer, 0n, _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common28vertex__buffer__byte__length);
  _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder18set__index__buffer(render_pass, renderer.index_buffer, 0, 0n, _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common41index__buffer__index__range__byte__length);
  _M0MP311emadurandal6WebGPU6webgpu20GPURenderPassEncoder21draw__indexed_2einner(render_pass, index_count, 1, 0, 0, 0);
...
function _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common13render__frame(renderer) {
  _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common28render__frame__with__options(renderer, new _M0TP311emadurandal6WebGPU13webgpu__enums8GPUColor(0, 0, 0.2, 1), 3);
}
function _M0FP511emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer2js4main31create__webgpu__renderer__async(canvas, _cont, _err_cont) {
  const _async_driver = (_state) => {
    const _State_0 = _state;
    const _cont_param = _State_0._0;
    ...
    let renderer;
    _L: {
      const _bind = _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common16create__renderer(ctx);
      if (_bind === undefined) {
    ...
    _M0FP411emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer6common13render__frame(renderer);
    return new _M0DTPC16result6ResultGOuRPC15error5ErrorE2Ok(_M0FPB7printlnGsE("WebGPU triangle (vertex + index buffer) rendered successfully!"));
  };
  const _bind = _M0FP411emadurandal17WebGPU_2dexamples6common7browser32gpu__context__from__html__canvas(canvas, (_cont_param) => {
    let _err;
    _L: {
      const _bind$2 = _async_driver(new _M0DTP511emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer2js4main107_24emadurandal_2fWebGPU_2dexamples_2ftriangle_2dwith_2dbuffer_2fjs_2fmain_2ecreate__webgpu__renderer__asyncL5State8State__0(_cont_param));
      let _bind$3;
      if (_bind$2.$tag === 1) {
        const _ok = _bind$2;
        _bind$3 = _ok._0;
  ...
  if (_bind$2 === undefined) {
    ...
    const _Some = _bind$2;
    const _payload = _Some;
    return _async_driver(new _M0DTP511emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer2js4main107_24emadurandal_2fWebGPU_2dexamples_2ftriangle_2dwith_2dbuffer_2fjs_2fmain_2ecreate__webgpu__renderer__asyncL5State8State__0(_payload));
  }
}
function _M0FP511emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer2js4main24create__webgpu__renderer(canvas) {
  return _M0MP311moonbitlang5async9js__async7Promise11from__asyncGuE((_cont, _err_cont) => _M0FP511emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer2js4main31create__webgpu__renderer__async(canvas, _cont, _err_cont), _M0DTPC16option6OptionGRP311moonbitlang5async9js__async11AbortSignalE4None__);
}
(() => {
  _M0FPB7printlnGsE("Hello");
})();
export { _M0FP511emadurandal17WebGPU_2dexamples24triangle_2dwith_2dbuffer2js4main24create__webgpu__renderer as create_webgpu_renderer }
